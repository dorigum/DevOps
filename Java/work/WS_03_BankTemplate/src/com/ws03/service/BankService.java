...
public class BankService {
	...
	final int ACCOUNT_SIZE = 10; // 최대 계좌 수
	final int USER_SIZE = 5; // 최대 고객 수

	int ACCOUNT_CURRENT_SIZE; // 0, 현재 계좌의 수 - 저장된 계좌의 수
	int USER_CURRENT_SIZE; // 0, 현재 고객의 수 - 저장된 고객의 수
	...
	public BankService() {
		...
		// 각 배열방에 고객과 계좌를 생성한다.
		// 고객 4명
		userList[USER_CURRENT_SIZE++] = new UserDto(100, "구도연", "kkamang03@gmail.com", "010-1111-2222", false);
	...
	public AccountDto[] getAccountList(int userSeq) { // 100
		...
		// 리턴해서 나갈 배열의 개수를 미리 알아내고 선언하기 위한 for 믄
